            ...
            <div>
              ...
              <div className="max-w-2xl">
                ...
                <p className="text-xl md:text-2xl text-gray-100 mb-8 leading-relaxed">
                  Master JavaScript programming from fundamentals to advanced concepts. Build real-world applications and become a professional JavaScript developer.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02] animate-fade-in-delay-1">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800">JavaScript Fundamentals</h3>
                    <p className="text-gray-700">Master the basics of JavaScript programming language, syntax, and core concepts including variables, data types, operators, and control flow.</p>
                  </div>
                </div>
                <div className="flex items-start bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02] animate-fade-in-delay-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800">DOM Manipulation</h3>
                    <p className="text-gray-700">Learn how to manipulate the Document Object Model (DOM) to dynamically update web pages.</p>
                  </div>
                </div>
                <div className="flex items-start bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02] animate-fade-in-delay-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800">Event Handling</h3>
                    <p className="text-gray-700">Learn how to handle events (mouse clicks, keyboard inputs, form submissions) in JavaScript.</p>
                  </div>
                </div>
                <div className="flex items-start bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02] animate-fade-in-delay-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800">Asynchronous Programming</h3>
                    <p className="text-gray-700">Learn how to handle asynchronous operations (AJAX, Promises, async/await) in JavaScript.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm animate-fade-in-delay-1">
                <p className="text-gray-700 mb-4">
                  This comprehensive JavaScript course is designed for both beginners and experienced programmers. You'll learn everything from basic syntax to advanced concepts like asynchronous programming and DOM manipulation.
                </p>
                <p className="text-gray-700 mb-4">
                  The course includes hands-on projects and real-world applications to help you build a strong foundation in JavaScript programming. You'll work on practical exercises, coding challenges, and real-world projects that will prepare you for professional JavaScript development.
                </p>
                <p className="text-gray-700">
                  By the end of this course, you'll be able to build robust JavaScript applications, understand design patterns, and be ready to tackle real-world programming challenges.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 h-fit sticky top-6 animate-fade-in">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-indigo-900">Start Learning JavaScript</h3>
                <p className="text-gray-700 mt-2">Comprehensive JavaScript Programming Course</p>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-indigo-50 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300 hover:scale-[1.05] animate-fade-in-delay-1">
              <SiJavascript className="text-4xl mx-auto text-yellow-400 mb-3" />
              <h3 className="font-semibold text-gray-800">JavaScript</h3>
              <p className="text-sm text-gray-700">Core Language</p>
            </div>
            <div className="bg-indigo-50 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300 hover:scale-[1.05] animate-fade-in-delay-2">
              <SiJquery className="text-4xl mx-auto text-blue-600 mb-3" />
              <h3 className="font-semibold text-gray-800">jQuery</h3>
              <p className="text-sm text-gray-700">JavaScript Library</p>
            </div>
            <div className="bg-indigo-50 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300 hover:scale-[1.05] animate-fade-in-delay-3">
              ...
              <p className="text-sm text-gray-700">JavaScript Framework</p>
            </div>
            <div className="bg-indigo-50 p-6 rounded-lg text-center hover:shadow-lg transition-all duration-300 hover:scale-[1.05] animate-fade-in-delay-4">
              ...
              <p className="text-sm text-gray-700">JavaScript Runtime</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.05] animate-fade-in-delay-1">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-800">JavaScript Developer</h3>
              <p className="text-gray-700">Build web applications and frontend systems</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.05] animate-fade-in-delay-2">
              ...
              <p className="text-gray-700">Build web applications and backend systems</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-indigo-50 p-6 rounded-lg hover:scale-[1.02] transition-all duration-300 animate-fade-in-delay-1">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-800">To-Do List</h3>
              <p className="text-gray-700 mb-4">Build a to-do list application with real-time updates and team collaboration features.</p>
            ...
            <div className="bg-indigo-50 p-6 rounded-lg hover:scale-[1.02] transition-all duration-300 animate-fade-in-delay-2">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-800">Quiz Application</h3>
              <p className="text-gray-700 mb-4">Create a quiz application with real-time updates and team collaboration features.</p>
              <ul className="list-disc list-inside text-gray-700">
                <li>User authentication and authorization</li>
                <li>Real-time updates</li>
                <li>Team collaboration</li>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm hover:scale-[1.02] transition-all duration-300 animate-fade-in-delay-1">
              <FaHtml5 className="text-2xl text-orange-600 mb-4" />
              <h3 className="font-semibold text-lg mb-2 text-gray-800">Basic HTML & CSS</h3>
              <p className="text-gray-700">Understanding of basic web technologies is helpful but not required.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm hover:scale-[1.02] transition-all duration-300 animate-fade-in-delay-2">
              <FaJs className="text-2xl text-yellow-400 mb-4" />
              <h3 className="font-semibold text-lg mb-2 text-gray-800">No JavaScript Experience Needed</h3>
              <p className="text-gray-700">We'll start from the very basics of JavaScript.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm hover:scale-[1.02] transition-all duration-300 animate-fade-in-delay-3">
              ...
              <p className="text-gray-700">A code editor (like VS Code) and modern web browser.</p>
            </div>
          </div>
        </div>
      </section>
