...
export const metadata = {
  title: 'Accessibility Statement | Lotlite Technology',
  description: 'Accessibility statement for Lotlite Technology platform and services.',
};
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6 text-gray-600">
            <section>
              ...
              <p>Lotlite Technology is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.</p>
            </section>
